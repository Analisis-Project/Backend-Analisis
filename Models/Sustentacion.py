...
# inicioH = time.time()
# mhd.heuristic(dicts, key = '100', letters='A0C0/ABC0')        
...
# inicioH = time.time()
# mhd.heuristic(dicts, key = '1000', letters='0BCDEF/AB00EF')
# finH = time.time()
# inicioPD = time.time()
...
# new_dict, dicts = subsystem(ABCDEFGH, 'ABC00000/ABC00000')
# inicioPD = time.time()
# mpd.bottom_up(dicts, key = '10000000', letters='ABCDEFGH/ABCDEFGH')   
# finPD = time.time()
# print("Tiempo Programacion Dinamica: ", finPD - inicioPD)
# inicioH = time.time()
# mhd.heuristic(dicts, key = '100', letters='ABC00000/ABC00000')

new_dict, dicts = subsystem(ABCDEFGHIJ, 'ABCDEF000J/A00DEFGHIJ')
inicioH = time.time()
mhd.heuristic(dicts, key = '10000000', letters='ABCDEF000J/A00DEFGHIJ')         
finH = time.time()
print("Tiempo Heuristica: ", finH - inicioH)